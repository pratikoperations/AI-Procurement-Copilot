...
def load_uploaded_rfq(uploaded_file):
    ...
    if raw_df.empty:
        raise RFQUploadError("The uploaded RFQ contains headers but no supplier rows. Add at least one supplier quotation and upload it again.")
    try:
