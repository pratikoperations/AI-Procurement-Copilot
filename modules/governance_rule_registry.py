...
RULES = (
    ...
    GovernanceRule("RULE-TECH-001", "1.0", "Technical ineligibility", "technical_ineligibility", ("All",), "category validation and Steel services", "category-specific eligibility services", "mandatory technical non-compliance remains ineligible", "removes supplier from eligible recommendation/allocation path", True),
    ...
    GovernanceRule("RULE-DEV-001", "1.0", "Approved deviation", "approved_deviation", ("All",), "modules/recommendation_eligibility.py", "evaluate_recommendation_eligibility", "exception requires documented approval outside autonomous logic", "does not remove human approval requirement", False),
