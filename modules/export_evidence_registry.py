...
EXPORT_EVIDENCE = (
    ...
    ExportEvidence("EXP-EV-004", "excel", "Allocation; Standard Allocation; Optimized Allocation", ("Packaging", "Raw materials"), ("ALC-001", "ALC-002"), "business-facing", "modules/exports.py", "build_excel_workbook"),
    ...
    ExportEvidence("EXP-EV-006", "json", "recommended_supplier; value_metrics; allocation; scenarios; negotiation; eligibility; flexible_laminates_governance.optimized_allocation; flexible_laminates_governance.scenarios", ("Packaging", "Raw materials", "Flexible Laminates"), ("SCR-001", "ALC-001", "ALC-002", "SCN-001", "SCN-002"), "audit-facing", "modules/exports.py", "build_decision_package_json"),
