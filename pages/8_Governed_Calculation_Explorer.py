...
from modules.calculation_explorer_ui import render_governed_calculation_explorer
...
explorer_payload = build_explorer_payload(
    context={"route": route_name, "mode": "read_only", "programme": "EAS-BIV Gate 4"},
...
render_governed_calculation_explorer(presentation)
